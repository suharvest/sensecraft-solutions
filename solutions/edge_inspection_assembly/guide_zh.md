...
0.9299、召回率 0.9741，与 CPU 参考在这批图上的数字相同。推理 p50 30.9 ms、p95
34.5 ms。同一模型的 fp16 版本一并发布：mAP50-95 0.8221、p50 110.3 ms。
...
`inspection/<设备名称>/results`，内含判定与判定依据、缺陷数、每个框的类别与分数、
