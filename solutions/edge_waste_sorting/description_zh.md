...
| 物料 top-1（1060 张子集），TensorRT 与 CPU 一致率 | **top-1 0.8755，一致率 0.9991** | reComputer J30 系列（Orin Nano 8GB） |
...
0.8889；reComputer J30（Orin Nano 8GB）在 1060 张子集上实测 TensorRT 物料
top-1 0.8755，与同一子集 CPU 结果一致率 99.91%。
