...
(p95 − p50 = 0.08 ms). They do not support: sustained-load behaviour on the
reComputer R2000 series chassis — this bench unit has different thermals and
power delivery, and that has not been separately verified. Only INT8 was measured: the
