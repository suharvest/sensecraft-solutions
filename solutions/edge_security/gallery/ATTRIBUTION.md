...
| `workbench-video-wall.jpg`, `workbench-video-wall-fullscreen.jpg`, `workbench-confidence-slider.jpg`, `workbench-add-camera.gif` | First-party captures of the shipped console UI against the kit's own `web/mock-server.js` — see "The four workbench assets" below. No third-party imagery; the colour-bar test picture inside each tile is generated by the mock server itself. |
