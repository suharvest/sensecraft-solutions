...
## Step 1: 烧录 D1001 固件 {#d1001_esp32 type=esp32_usb required=true config=devices/d1001_esp32.yaml}
...
## Step 2: 联网与绑定 {#d1001_setup type=manual required=false}
...
说"小智小智"唤醒设备；回答途中再次说唤醒词可以直接打断。

### 可选：人脸唤醒

点状态栏的人形图标打开人脸设置：模式磁贴（关闭/检测唤醒/识别唤醒）、持续确认、唤醒冷却与识别服务地址。
