...
| 门口能做到什么 | 典型值 | 设备 |
|---|---|---|
| 新发布的人脸库在门口生效 | **0.49 秒** p50（p95 0.51 秒） | reCamera |
| 上电到门禁应用可用 | **8.8 秒** 中位，6 次上电测试 | reCamera |

生效时间随人脸库规模增长——同一条链路上 402 人约 9.8 秒、1502 人约 22 秒——
大库的首次同步要留出时间。被篡改的人脸库与签名不对的更新会在设备侧被拒绝，
门口继续用手上已有的那一版。
